...
Desktop Members module for CountIn Web. Mobile remains the business source of truth for APIs, DTOs, permissions, validation, and terminology. Presentation uses a **master-detail workspace** instead of stacked mobile screens.
