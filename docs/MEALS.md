...
Desktop Meals Management module for Acomi Web. Mobile remains the business source of truth for APIs, DTOs, permissions, validation, poll/menu lifecycle, and terminology. Presentation uses a **planner workspace** (today + tomorrow, Breakfast/Lunch/Dinner together) instead of stacked mobile screens.
