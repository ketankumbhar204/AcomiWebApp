...
assert(registerPage.includes('ROUTES.registerOtp'), 'register page must open the OTP screen when OTP is required');
assert(registerPage.includes('otpSkipped'), 'register page must honor local OTP skip from send-otp');
assert(registerPage.includes('useRegister'), 'register page must complete registration when OTP is skipped');
